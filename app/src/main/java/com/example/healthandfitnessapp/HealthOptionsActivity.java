...
public class HealthOptionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthy_options);
        ...
        // api provider
        final EdamamApiService apiService = new EdamamApiService(HealthOptionsActivity.this);
        searchResults = new ArrayList<>();

        // populate the ui here
        resultsAdapter = new DisplayResultsAdapter(HealthOptionsActivity.this, searchResults);
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2, GridLayoutManager.VERTICAL, false);
        displayRecycleView.setLayoutManager(gridLayoutManager);

        //AutoFitGridLayoutManager autoFitGridLayoutManager = new AutoFitGridLayoutManager(HealthOptionsActivity.this, 500);
            ...
            public void onClick(View view) {
                ...
                apiService.getRecipeInfo(userQuery, new EdamamApiService.GetRecipeCallback() {
                    ...
                    public void onResponse(List<RecipeModel> recipe) {
                        ...
                        // Toast.makeText(HealthOptionsActivity.this, recipe.get(0).toString(), Toast.LENGTH_LONG).show();
                    ...
                    public void onError(String message) {
                        Toast.makeText(HealthOptionsActivity.this, message, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
